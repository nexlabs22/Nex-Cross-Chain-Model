    ...
    ReentrancyGuardUpgradeable
{
    ...
    function withdrawAndCrossChainToken(
        ...
        _sendCrossChainToken(_chainSelector, _crossChainReceiver, balance);
    }
    ...
    function _sendCrossChainToken(
        ...
        uint crossChainFee = calculateCrossChainFee(_chainSelector, _value, _crossChainReceiver);
        require(_value >= crossChainFee, "Insufficient fee");
        uint transferWethAmount = _value - crossChainFee;
        ...
        ) = factoryStorage.getFromETHPathData(
                factoryStorage.crossChainToken(_chainSelector)
            );
        ...
        tokensToSendArray[0].token = factoryStorage.crossChainToken(
            _chainSelector
        );
    ...
    function calculateCrossChainFee(
        ...
        uint256 crossChainTokenAmount = factoryStorage.getAmountOut(
            fromETHPath,
            fromETHFees,
            _wethAmount
        );
