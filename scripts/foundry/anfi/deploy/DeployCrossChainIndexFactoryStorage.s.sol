...
contract DeployCrossChainIndexFactoryStorage is Script {
    function run() external {
        ...
        CrossChainIndexFactoryStorage crossChainIndexFactoryStorageImplementation = new CrossChainIndexFactoryStorage();
        ...
        TransparentUpgradeableProxy proxy = new TransparentUpgradeableProxy(
            address(crossChainIndexFactoryStorageImplementation), address(proxyAdmin), data
        );

        console.log(
            "CrossChainIndexFactoryStorage implementation deployed at:",
            address(crossChainIndexFactoryStorageImplementation)
        );
        console.log("CrossChainIndexFactoryStorage proxy deployed at:", address(proxy));
        console.log("ProxyAdmin for CrossChainIndexFactoryStorage deployed at:", address(proxyAdmin));
