...
contract UpgradeCrossChainFeeSender is Script {
    function run() external {
        ...
        // address proxyAdminAddress = vm.envAddress("CR5_SEPOLIA_FEE_SENDER_PROXY_ADMIN_ADDRESS");
        // address crossChainFeeSenderProxyAddress = vm.envAddress("CR5_SEPOLIA_FEE_SENDER_PROXY_ADDRESS");
        address proxyAdminAddress = vm.envAddress("CR5_ARBITRUM_CROSS_CHAIN_FEE_SENDER_PROXY_ADMIN_ADDRESS");
        address crossChainFeeSenderProxyAddress = vm.envAddress("CR5_ARBITRUM_CROSS_CHAIN_FEE_SENDER_PROXY_ADDRESS");
