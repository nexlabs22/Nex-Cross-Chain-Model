...
contract UpgradeIndexFactoryStorage is Script {
    function run() external {
        ...
        // Mainnet
        address proxyAdminAddress = vm.envAddress("CR5_ARBITRUM_INDEX_FACTORY_STORAGE_PROXY_ADMIN_ADDRESS");
        address indexFactoryStorageProxyAddress = vm.envAddress("CR5_ARBITRUM_INDEX_FACTORY_STORAGE_PROXY_ADDRESS");

        // Testnet
        // address proxyAdminAddress = vm.envAddress("CR5_SEPOLIA_INDEX_FACTORY_STORAGE_PROXY_ADMIN_ADDRESS");
        // address indexFactoryStorageProxyAddress = vm.envAddress("CR5_SEPOLIA_INDEX_FACTORY_STORAGE_PROXY_ADDRESS");
