...
import { mumbaiChainSelector, mumbaiTestRippleAddress, sepoliaBitcoinAddress, sepoliaCR5IndexFactory, sepoliaCR5IndexFactoryStorage, sepoliaChainSelector, sepoliaTestBinanceAddress, sepoliaTestEthereumAddress, sepoliaTestSolanaAddress } from "../network";
...
async function main() {
    ...
    const result = await cotract.connect(deployer).issuanceIndexTokensWithEth(
        ...
        "0",
        {value: ethers.utils.parseEther("0.001001"), gasLimit: 2000000}
    )
