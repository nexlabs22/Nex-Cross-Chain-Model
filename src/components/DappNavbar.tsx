			...
			<Link href={'https://landing-page-spot-index.vercel.app/'}>
				<div className="flex flex-row items-center justify-between">
					<div className=" mr-2 h-fit w-fit">
						<Image src={logo2} alt="nex labs logo" className="w-12"></Image>
					</div>
				</div>
			</Link>
					...
					<div className="w-full h-full flex flex-col items-center justify-around">
						<div className='w-fit h-fit flex flex-col items-center justify-center gap-10'>
							<Link href={'/'} onClick={() => {
								...
								<h5 className="pangramMedium text-3xl text-blackText-500">Dashboard</h5>
							</Link>
							<Link href={'/trade'} onClick={() => {
								setOpenMobileMenu(false)
							}}>
								<h5 className="pangramMedium text-3xl text-blackText-500">Trade</h5>
							</Link>
							<Link href={'/convert'} onClick={() => {
								setOpenMobileMenu(false)
							}}>
								<h5 className="pangramMedium text-3xl text-blackText-500">Convert</h5>
							</Link>
							<Link href={'/portfolio'} onClick={() => {
								setOpenMobileMenu(false)
							}}>
								<h5 className="pangramMedium text-3xl text-blackText-500">Portfolio</h5>
							</Link>
						</div>
						<div className="pt-10">
							<ConnectButton />
