					...
					{comparisonIndices.map((item, index) => {
						return (
							<div key={index} className="indexContainer">
								<div
									className="mx-2 flex h-5/6 w-full cursor-pointer flex-row items-center justify-between rounded-3xl px-3 hover:bg-gray-200/50"
									style={{
								...
								>
									<div className="flex w-9/12 flex-row items-center justify-start">
										...
										<div className="indexDataContainer flex h-fit w-3/5 flex-col items-start justify-center">
											<h5 className="ARPDisplay-150 mb-3 text-base text-blackText-500">{item.name}</h5>
											<div className="flex w-full flex-row items-center justify-start">
												<h5 className="ARPDisplay-150 mr-5 text-base text-blackText-500">{item.price} USD</h5>
												<h5 className="ARPDisplay-150 text-base text-nexLightRed-500">{item.change}%</h5>
											</div>
										</div>
									</div>
