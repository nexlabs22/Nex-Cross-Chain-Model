...
const PWAGenericAvatar: React.FC<AvatarProps> = ({ walletAddress }) => {
	...
	return (
		<div className=" w-20 h-20 z-10 relative aspect-square bg-colorOne-500 rounded-full flex flex-col items-center justify-center">
			<Image src={`data:image/png;base64,${identiconDataUrl}`} width={8} height={8} className='w-full h-full rounded-full' alt="Identicon" />
		</div>
	)
}

export default PWAGenericAvatar;
