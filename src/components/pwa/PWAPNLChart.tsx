...
const PWAPortfolioPNLChart: React.FC<GradientAreaChartProps> = ({ data, change,totalPortfolioBalance }) => {
	...
	return (
		<div className="relative w-full h-[10vh]">
			<div className="absolute top-0 left-0 w-full h-full z-50">
				...
				<div className="pt-4 px-[10%] flex flex-col items-end justify-start h-full w-full">
					<h1
...
export default PWAPortfolioPNLChart
