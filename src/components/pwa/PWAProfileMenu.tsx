...
const PWAProfileMenu = () => {
    return (
        <Stack width={"100%"} height={"fit-content"} direction={"column"} alignItems={"center"} justifyContent={"start"} marginY={3} paddingX={2} paddingY={2} gap={4}>
            <Link href={"/pwa_overview"} className="w-full h-fit flex flex-row items-center justify-center">
            ...
            <Link href={""} target="_blank" className="w-full h-fit flex flex-row items-center justify-center">
