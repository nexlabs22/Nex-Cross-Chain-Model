...
const GenericStakingCard1: React.FC<GenericStakingCardProps> = ({ index }) => {
    ...
    return (
        <Stack width={"100%"} height={"fit-content"} direction={"column"} alignItems={"start"} justifyContent={"start"} borderRadius={"1.2rem"} sx={{
            ...
            <Stack direction={"column"} width="100%" height="fit-content" alignItems={"start"} justifyContent={"start"} border={"none"} gap={4} paddingX={4} paddingY={3}>
            ...
            <Stack direction={"row"} width="100%" height="fit-content" alignItems={"center"} justifyContent={"space-between"} border={"none"} gap={2} paddingX={4} paddingY={3}>
                ...
                <Stack width={"fit-content"} height="fit-content" borderRadius={"0.8rem"} paddingX={4} paddingY={1} sx={{
                    ...
                    boxShadow: "0px 0px 1.5px 6px rgba(95,81,38,0.3)"
                }}>
