...
import { Typography, Stack, CircularProgress, Box, circularProgressClasses } from "@mui/material";
...
const StakedAmountCard = ({ index, percentage, amount }: StakedAmountCardProps) => {
    return (
        <GenericCard>
            <Stack spacing={3}>
