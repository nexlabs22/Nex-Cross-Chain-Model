...
import { Stack, Typography, Button, IconButton, Input, Divider } from "@mui/material";
        ...
        <Stack width="100%" gap={2} sx={{
            ...
            <Stack direction="row" justifyContent="space-between" alignItems="center">
                <Typography variant="h4" color="primary">
                    {selectedSide === 'stake' ? 'Stake' : 'Unstake'} {defaultToken?.symbol}
                </Typography>
            ...
            <Stack direction="row" alignItems="end" justifyContent="space-between" gap={2}>
                ...
                <Stack direction="row" alignItems="center" gap={1}>
                    <Button variant="contained" size="small" sx={{
                        backgroundColor: selectedSide === 'stake' ? theme.palette.brand.nex1.main : theme.palette.elevations.elevation700.main,
                        padding: 0.5,
                    }} onClick={() => setSelectedSide('stake')}>
                        Stake
                    </Button>
                    <Button variant="contained" size="small" sx={{
                        backgroundColor: selectedSide === 'unstake' ? theme.palette.brand.nexRed.main : theme.palette.elevations.elevation700.main,
                        padding: 0.5,
            ...
            <Button fullWidth variant="contained" sx={{
                backgroundColor: amount > 0 ? theme.palette.brand.nex1.main : theme.palette.elevations.elevation800.main,
                color: amount > 0 ? theme.palette.info.main : theme.palette.elevations.elevation400.main,
