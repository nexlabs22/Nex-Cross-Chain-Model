...
import { AllowedTickers, TokenObject, SmartContractType, TokenAddressMap } from "@/types/indexTypes"
...
export const nexTokensArray: TokenObject[] = [
  {
    symbol: "ANFI",
    columnName: "ANFI",
  ...
  },
  {
    ...
    tokenAddresses: tokenAddresses["CRYPTO5"] as TokenAddressMap[AllowedTickers],
