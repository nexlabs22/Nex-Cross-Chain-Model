		...
		<>
			...
			>
				...
				<section className="w-screen h-fit flex flex-col items-stretch justify-start px-4 lg:px-10 pt-10 pb-12">
					...
					<p className={` text-sm leading-normal mt-4 xl:w-full lg:text-justify interBold ${mode == "dark" ? " text-whiteText-500" : " text-blackText-500"}`}>
						1. Information gathering
					</p>
					<p className={` text-sm italic leading-normal mt-4 xl:w-full lg:text-justify interMedium ${mode == "dark" ? " text-whiteText-500" : " text-blackText-500"}`}>
					Information you provide
					</p>
					<p className={` text-sm leading-normal mt-4 xl:w-full lg:text-justify interMedium ${mode == "dark" ? " text-whiteText-500" : " text-blackText-500"}`}>
					We may collect the following information about you when you use the Services:
					</p>
					<p className={` text-sm ml-4 leading-normal mt-4 xl:w-full lg:text-justify interMedium ${mode == "dark" ? " text-whiteText-500" : " text-blackText-500"}`}>
					...
					<p className={` text-sm ml-4 leading-normal mt-4 xl:w-full lg:text-justify interBold ${mode == "dark" ? " text-whiteText-500" : " text-blackText-500"}`}>
                    A- DO WE USE COOKIES?
					</p>
					<p className={` text-sm ml-4 leading-normal mt-4 xl:w-full lg:text-justify interMedium ${mode == "dark" ? " text-whiteText-500" : " text-blackText-500"}`}>
					...
					<p className={` text-sm ml-6 leading-normal mt-4 xl:w-full lg:text-justify interBold ${mode == "dark" ? " text-whiteText-500" : " text-blackText-500"}`}>
