		...
		<>
			...
			>
				<section className="h-full w-fit overflow-x-hidden">
					...
					>
						Unlock promising rewards by staking Nex Labs Index tokens. By locking your tokens into Nex staking pool for a set period, you could earn interest on your holdings, similar to earning
						interest on a traditional savings account but potentially with higher returns. However, it{"'"}s important to remember that staking involves temporarily giving up control of your
						tokens and may come with associated risks, such as potential price volatility of the underlying assets or even smart contract bugs.
					</Typography>
					<Stack width={'100%'} height={'fit-content'} paddingX={8} marginY={'1rem'}>
						...
						<Stack width={'100%'} height={'fit-content'} direction={'row'} alignItems={'center'} justifyContent={'start'} gap={6} marginTop={'1.2rem'}>
							<Link
								...
								onClick={(e) => {
									e.preventDefault()
									handleStakingIndexChange(anfiIndexObject as indexObjectType)
								}}
							>
							...
							<Link
								...
								onClick={(e) => {
									e.preventDefault()
									handleStakingIndexChange(cr5IndexObject as indexObjectType)
								}}
							>
								<Stack direction={'row'} alignItems={'center'} justifyContent={'start'} gap={1}>
							...
							<Link
								...
								onClick={(e) => {
									e.preventDefault()
									handleStakingIndexChange(mag7IndexObject as indexObjectType)
								}}
							>
								<Stack direction={'row'} alignItems={'center'} justifyContent={'start'} gap={1}>
							...
							<Link
								...
								onClick={(e) => {
									e.preventDefault()
									handleStakingIndexChange(arbIndexObject as indexObjectType)
								}}
							>
								<Stack direction={'row'} alignItems={'center'} justifyContent={'start'} gap={1}>
					...
					<Box sx={{ width: '100%', display: 'flex', alignItems: 'flex-end' }}>
						...
						>
							*Values are in the native token i.e {selectedStakingIndex?.symbol}
						</Typography>
					</Box>
