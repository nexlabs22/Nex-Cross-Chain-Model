...
import { addLiquidityEth, deployment, updateOracleList } from "./Deployer";
  ...
  describe("TEST REWEIGHT CR5 Weth", function () {
    ...
    describe("Deployment", function () {
      ...
      it("Test factory single swap", async function () {
        ...
        console.log("token1 after swap:", ethers.utils.formatEther(await weth9.balanceOf(indexToken.address)))
        ...
        console.log("first token2 value:", ethers.utils.formatEther(await indexFactoryBalancer.tokenValueByNonce(1, weth9.address)))
        ...
        //
        console.log("weth balance befor reweight:", ethers.utils.formatEther(await weth9.balanceOf(indexToken.address)));
        ...
        console.log("second token2 value:", ethers.utils.formatEther(await indexFactoryBalancer.tokenValueByNonce(2, weth9.address)))
